...
class Database {
    ...
    function addUser($user) {
        ...
        $query = "INSERT INTO Users
                  VALUES (:username, :firstName, :lastName, :email, :password, :address, :zip);";
        ...
        $ps->bindParam(':address', $newAddress);
        $ps->bindParam(':zip', $newZip);
        $ps->execute();
    ...
    function getUserInfo($user) {
        ...
        $statement = "SELECT FirstName, LastName, EmailAddress, Address, Zip
                      FROM Users
                      WHERE UserName = \"$username\";";
